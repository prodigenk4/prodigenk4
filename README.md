...
Mes centres d’intérêt portent sur le machine learning, la modélisation statistique, l’économétrie et l’exploitation avancée des données pour concevoir des solutions intelligentes et responsables.

Je développe des projets en Python, R et SQL, en mettant l’accent sur des applications concrètes, robustes et interprétables, adaptées aux besoins réels des organisations.
...
#### **[Scoring Crédit – Modèle de Risque](https://github.com/prodigenk4/scoring-credit)**  
📊 *Machine Learning · Risk Modeling · Python*  
...
⭐ *N'hésitez pas à explorer mes repos, à ouvrir des issues ou à contribuer !*
